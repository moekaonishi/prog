...
<header>
  <nav class="navbar navbar-default">
    ...
    <div class="navbar-header"><a class="navbar-brand" href="#">写真アッ
プロード</a></div>
      <ul class="pager">
      <li class="previous"><a href="file_chek.html">← カメラ／写真選択</
a></li>
...
<script src='https://www.bing.com/api/maps/mapcontrol?callback=GetMap&key=AjXxwtJ4Fq5-09AQ1hzreiRsk21-EoIScauVKcEZU8rf1iLiQgZd0HVCkrVpaPJK'
...
function GetMap(){
    ...
    for(let i=0; i<len;i++){
        ...
        let h =  '<div>'+name[i]+'<br>'+input_date[i]+'<br><img src="upload/'+img[i]+'"></div>';
